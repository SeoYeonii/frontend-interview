...
| 질문                                                              | 중요도  |
| :---------------------------------------------------------------- | :-----: |
| `useReducer` 훅이란 무엇이며, 어떻게 사용하는지 설명해주세요.     | ✅ 중요 |
| `useState`와 `useReducer`는 어떻게 비교할 수 있나요?              | ✅ 중요 |
| `useContext` 훅을 사용할 때 context는 어떻게 동작하나요?          | ✅ 중요 |
| `useContext` 훅은 보통 어떤 상황에서 사용하나요?                  | ✅ 중요 |
| useMemo와 useCallback의 차이점은? 언제 사용하는가?                | ✅ 중요 |
| 커스텀 훅(Custom Hook)은 언제 만들고 어떻게 구성하나요?           | ✅ 중요 |
| useRef는 DOM 접근 외에 어떤 용도로 사용할 수 있나요?              | ✅ 중요 |
| useEffect cleanup 함수는 언제 호출되나요?                         | ✅ 중요 |
